...
namespace INF::GFX
{
	...
	void D3D12Queue::ExecuteCommandLists(ID3D12GraphicsCommandList* commandLists, uint32_t commandListCount)
	{
		ID3D12CommandList* pCommandList = commandLists;
		Queue->ExecuteCommandLists(commandListCount, &pCommandList);
