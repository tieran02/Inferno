...
{
    string INFERNO_ROOT = @"[project.SharpmakeCsPath]/..";
    string INFERNO_PROJECTS = Path.Combine(@"[project.SharpmakeCsPath]", "/../projects");
    string INFERNO_ENGINE = Path.Combine(@"[project.SharpmakeCsPath]", "/../engine");
	...
	public void ConfigureAll(Project.Configuration conf, Target target)
	{
		...
		conf.ProjectPath = INFERNO_PROJECTS;
...
public class BasicsSolution : Solution
{
    string INFERNO_ROOT = @"[project.SharpmakeCsPath]/..";
    string INFERNO_PROJECTS = Path.Combine(@"[project.SharpmakeCsPath]", "/../projects");
    string INFERNO_ENGINE = @"[project.SharpmakeCsPath]/../engine";
    ...
    public void ConfigureAll(Solution.Configuration conf, Target target)
    {
        ...
        conf.SolutionPath = INFERNO_PROJECTS;
